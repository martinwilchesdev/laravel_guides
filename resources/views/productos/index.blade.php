...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <a href="{{ route('productos.create') }}" class="bg-black text-white px-4 py-2 rounded hover:bg-black/85">Agregar
            producto</a>
        ...
        <div class="w-full mt-4 flex justify-between items-center">
            ...
            <form method="GET" class="flex space-x-2">
                ...
                <button class="bg-black text-white font-bold py-2 px-4 cursor-pointer rounded hover:bg-black/85"
                ...
                @if (request('search'))
                    <a href="{{ route('productos.index') }}"
                        class="bg-gray-500 text-white flex items-center py-2 px-4 cursor-pointer rounded hover:bg-gray-600">
                        Restablecer
                    </a>
                @endif
            </form>
                    ...
                    <tr class="hover:bg-gray-200">
                        ...
                        <td class="border border-gray-300 px-4 py-2">
                            ...
                            <form action="{{ route('productos.destroy', $producto->id) }}" method="POST"
                                ...
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="bg-red-500 text-white px-2 py-1 cursor-pointer rounded"
                                    onclick="return confirm('¿Estás seguro que deseas eliminar el producto?')">
                                    Eliminar
                                </button>
                            </form>
                        </td>
